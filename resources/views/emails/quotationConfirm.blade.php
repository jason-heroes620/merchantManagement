...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <br>
            <p>We have generated a quotation as per your request. Please proceed to log in and review your quotation.</p>
            <p>Your Quotation No.: <b>{{ $quotation->quotation_no }}</b></p>
