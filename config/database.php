    ...
    */
    ...
    'connections' => [
        ...
        'journey' => [
            ...
            'host' => env('JOURNEY_DB_HOST', '127.0.0.1'),
            'port' => env('JOURNEY_DB_PORT', '3306'),
            'database' => env('JOURNEY_DB_DATABASE', ''),
            'username' => env('JOURNEY_DB_USERNAME', 'root'),
            'password' => env('JOURNEY_DB_PASSWORD', ''),
